...
def getDateTimeInParticularCalendar(wishedCalendarSystem, wishedDateTime = datetime.now()):
    ...
    #
        ...
        return {"calendar": wishedCalendarSystem, "date_and_time": str(convertdate.french_republican.from_gregorian(wishedDateTime.year, wishedDateTime.month, wishedDateTime.day))}, 200
    ...
    #
        ...
        return {"calendar": wishedCalendarSystem, "date_and_time": str(convertdate.julian.from_gregorian(wishedDateTime.year, wishedDateTime.month, wishedDateTime.day))}, 200
    ...
    #
        ...
        return {"calendar": wishedCalendarSystem, "date_and_time": str(convertdate.ordinal.from_gregorian(wishedDateTime.year, wishedDateTime.month, wishedDateTime.day))}, 200
    ...
    #
        ...
        return {"calendar": wishedCalendarSystem, "date_and_time": str(convertdate.positivist.from_gregorian(wishedDateTime.year, wishedDateTime.month, wishedDateTime.day))}, 200
