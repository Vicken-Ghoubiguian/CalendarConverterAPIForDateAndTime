...
parser_current_date_and_time_by_timezone_for_conversion.add_argument('datetime', type=inputs.datetime_from_iso8601, required=True, help='Wished date and time according to the UTC time zone')
